module.exports = function initDB(db) {
    ...
    db.serialize(() => {
        ...
        db.run(`CREATE TABLE IF NOT EXISTS challenges (
            ...
            rarity TEXT NOT NULL, -- 'epic', 'rare', 'common', 'troll'
            reward INTEGER NOT NULL,
            is_active BOOLEAN DEFAULT 1,
            created_at DATETIME DEFAULT CURRENT_TIMESTAMP
        )`);

        // User challenges table (active challenges)
        db.run(`CREATE TABLE IF NOT EXISTS user_challenges (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            user_id INTEGER NOT NULL,
            challenge_id INTEGER NOT NULL,
            status TEXT DEFAULT 'active', -- 'active', 'pending', 'completed', 'failed'
            created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
        ...
        // Used challenges table (to prevent repeats)
        ...
        db.run(`CREATE TABLE IF NOT EXISTS transactions (
            ...
            type TEXT NOT NULL, -- 'challenge_reward', 'card_replace', 'troll_penalty'
            description TEXT,
            created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
            FOREIGN KEY (team_id) REFERENCES teams (id)
        )`);

        // Settings table (for probabilities)
